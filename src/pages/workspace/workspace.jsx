...
function Workspace() {
  ...
  return (
    <div className="grid grid-cols-12  px-3 py-5  md:px-0 md:py-0 grid-rows-1 gap-0 md:grid-cols-12 md:grid-rows-2 md:gap-x-3 md:gap-y-5 h-[100vh] w-[100vw] ">
      ...
      {isLoading && (
        <div className=" col-span-12 md:pr-3 grid grid-cols-1 gap-3 mt-10 md:py-5 md:m-0 md:col-span-10 md:grid-cols-12 md:grid-rows-2 md:row-span-2 animate-pulse">
          <div
            role="status"
