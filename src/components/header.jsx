...
function Header() {
  ...
  return (
    <header className="fixed top-7 w-full px-[1.5rem]">
      <nav
        className={`container-main border-2 border-primary px-[15px] py-[15px] rounded-border`}
      ...
      >
        ...
        <ul role="list" className="flex justify-between md:hidden z-50">
          ...
          <li className="flex items-center">
            <NavLink className="px-[1.5em]">
              <img src={LogoColor} alt="LeadUp Logo" className=" h-[25px]" />
            </NavLink>
          </li>
          <li className=" flex items-center">
            <button
              className="px-[1.5em] py-[0.5em] inline"
              onClick={() => {
        ...
        <ul
          role="list"
          className=" md:hidden  top-[125px] right-8 border-2 border-primary px-[15px] py-[15px] rounded-border flex flex-col gap-[20px] z-50"
          style={{
